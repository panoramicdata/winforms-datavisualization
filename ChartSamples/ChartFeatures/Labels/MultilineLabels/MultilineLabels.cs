...
namespace ChartSamples
{
	...
	/// </summary>
	public class MultilineLabels : UserControl
	{
		...
		private TextBox AxisLabel;
		private TextBox PointLabel;
		private CheckBox ShowValueLabels;
		...
		private void InitializeComponent()
		{
			...
			DataPoint dataPoint7 = new DataPoint(3, 82);
			...
			ComponentResourceManager resources = new ComponentResourceManager(typeof(MultilineLabels));
            label9 = new Label();
            panel1 = new Panel();
            ShowValueLabels = new CheckBox();
            PointLabel = new TextBox();
            AxisLabel = new TextBox();
            label2 = new Label();
            label1 = new Label();
            label6 = new Label();
            label5 = new Label();
            ...
            label9.Name = "label9";
            label9.Size = new Size(702, 48);
            label9.TabIndex = 0;
            label9.Text = "This sample demonstrates how to set labels for point values. It also shows how to" +
                " set labels for individual data points.";
            // 
            // panel1
            // 
            panel1.Controls.Add(ShowValueLabels);
            panel1.Controls.Add(PointLabel);
            panel1.Controls.Add(AxisLabel);
            ...
            // ShowValueLabels
            // 
            ShowValueLabels.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
            ShowValueLabels.Location = new Point(26, 7);
            ShowValueLabels.Name = "ShowValueLabels";
            ShowValueLabels.Size = new Size(156, 23);
            ShowValueLabels.TabIndex = 0;
            ShowValueLabels.Text = "&Show Point Values:";
            ShowValueLabels.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            ShowValueLabels.CheckedChanged += new EventHandler(Combo_SelectedIndexChanged);
            // 
            // PointLabel
            // 
            PointLabel.Location = new Point(168, 72);
            PointLabel.Name = "PointLabel";
            PointLabel.Size = new Size(120, 22);
            PointLabel.TabIndex = 4;
            PointLabel.Text = "Point Label #3";
            PointLabel.TextChanged += new EventHandler(Combo_SelectedIndexChanged);
            // 
            // AxisLabel
            // 
            AxisLabel.Location = new Point(168, 40);
            AxisLabel.Name = "AxisLabel";
            AxisLabel.Size = new Size(120, 22);
            AxisLabel.TabIndex = 3;
            AxisLabel.Text = "Axis Label #3";
            AxisLabel.TextChanged += new EventHandler(Combo_SelectedIndexChanged);
            // 
            // label2
            // 
            ...
            label7.Location = new Point(16, 368);
            label7.Name = "label7";
            label7.Size = new Size(702, 57);
            label7.TabIndex = 3;
