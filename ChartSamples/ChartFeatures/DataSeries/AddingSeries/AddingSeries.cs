...
namespace ChartSamples
{
	...
	/// </summary>
	public class AddingSeries : UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            label9.TabIndex = 0;
            label9.Text = "This sample demonstrates how to add and remove a data series from the Chart contr" +
                "ol.";
            ...
            // RemoveButton
            // 
            RemoveButton.BackColor = System.Drawing.SystemColors.Control;
            RemoveButton.Location = new Point(48, 40);
            RemoveButton.Name = "RemoveButton";
            RemoveButton.Size = new Size(88, 23);
            ...
            AddButton.Location = new Point(48, 4);
            ...
            Chart1.Location = new Point(8, 56);
            Chart1.Name = "Chart1";
            ...
            label1.Location = new Point(8, 368);
            label1.Name = "label1";
            label1.Size = new Size(702, 45);
            label1.TabIndex = 20;
            label1.Text = "This sample also uses serialization to automatically save and load the data and a" +
            ...
            Load += new EventHandler(AddingSeries_Load);
		...
		private void AddingSeries_Load(object sender, EventArgs e)
		{
