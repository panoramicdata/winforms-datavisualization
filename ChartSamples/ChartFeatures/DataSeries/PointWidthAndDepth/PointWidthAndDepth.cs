...
namespace ChartSamples
{
	...
	public class PointWidthAndDepth: System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            this.numericUpDownGap.Increment = new decimal([
            10,
            0,
            0,
            0]);
            this.numericUpDownGap.Location = new System.Drawing.Point(168, 136);
            this.numericUpDownGap.Maximum = new decimal([
            500,
            0,
            0,
            0]);
            this.numericUpDownGap.Minimum = new decimal([
            5,
            0,
            0,
            0]);
            ...
            this.numericUpDownGap.Value = new decimal([
            10,
            0,
            0,
            0]);
            ...
            this.numericUpDownDepth.Increment = new decimal([
            10,
            0,
            0,
            0]);
            this.numericUpDownDepth.Location = new System.Drawing.Point(168, 104);
            this.numericUpDownDepth.Maximum = new decimal([
            500,
            0,
            0,
            0]);
            this.numericUpDownDepth.Minimum = new decimal([
            5,
            0,
            0,
            0]);
            ...
            this.numericUpDownDepth.Value = new decimal([
            70,
            0,
            0,
            0]);
            ...
            // numericUpDownWidth
            // 
            this.numericUpDownWidth.Increment = new decimal([
            5,
            0,
            0,
            0]);
            ...
            0,
            0]);
            this.numericUpDownWidth.Minimum = new decimal([
            5,
            0,
            0,
            0]);
