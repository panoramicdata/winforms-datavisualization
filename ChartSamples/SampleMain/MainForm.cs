...
namespace ChartSamples
{
	...
	public class MainForm : Form
	{
		...
		private PictureBox pictureBoxHeaderLeft;
		private TiledPictureBox pictureBoxHeaderMidle;
		private PictureBox pictureBoxHeaderRight;
		...
		private Button buttonSamplePrevious;
		private Button buttonSampleNext;
		...
		public MainForm()
		{
			...
			if (g != null)
			{
				...
				{
					scaleRatioX = g.DpiX / 96f;
					scaleRatioY = g.DpiY / 96f;
				}
			}
			g.Dispose();
			...
			tabControlContent.TabPages[0].Controls.Add(treeSamples);
			treeSamples.Dock = DockStyle.Fill;

			// Add Index page
			tabControlContent.TabPages.Add("Index");
			tabControlContent.TabPages[1].Controls.Add(panelIndex);
			panelIndex.Dock = DockStyle.Fill;

			// Add event handler when selected tab changes
			tabControlContent.SelectedIndexChanged += new EventHandler(tabControlContent_SelectedIndexChanged);

			// Add tab control into the panel
			panelTree.Controls.Add(tabControlContent);
			...
			tabControlSample.SelectedIndexChanged += new EventHandler(tabControlSample_SelectedIndexChanged);
			...
			labelSampleTitle.Width = Width - labelSampleTitle.Left - 4;
			...
			if (scaleRatioX != 1f || scaleRatioY != 1f)
			{
				buttonSamplePrevious.Width = (int)(buttonSamplePrevious.Width * scaleRatioX);
				buttonSamplePrevious.Height = (int)(buttonSamplePrevious.Height * scaleRatioY);
				buttonSampleNext.Width = (int)(buttonSampleNext.Width * scaleRatioX);
				buttonSampleNext.Height = (int)(buttonSampleNext.Height * scaleRatioY);
			}
			...
			buttonSampleNext.Left = Width - buttonSampleNext.Width - 15;
		...
		private void InitializeComponent()
		{
			...
			// panelTree
			//
			panelTree.BackColor = System.Drawing.Color.White;
			...
			panelTree.Size = new Size(256, 436);
			panelTree.TabIndex = 0;
			//
			// panelIndex
			//
			panelIndex.BackColor = System.Drawing.SystemColors.Window;
			panelIndex.Controls.Add(listBoxIndex);
			panelIndex.Controls.Add(textBoxIndex);
			panelIndex.Controls.Add(label1);
			panelIndex.Font = new Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			// listBoxIndex
			//
			listBoxIndex.Anchor = ((AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			listBoxIndex.Font = new Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			listBoxIndex.SelectedIndexChanged += new EventHandler(listBoxIndex_SelectedIndexChanged);
			//
			// textBoxIndex
			//
			textBoxIndex.AcceptsReturn = true;
			textBoxIndex.Anchor = ((AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			textBoxIndex.Font = new Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			textBoxIndex.TextChanged += new EventHandler(textBoxIndex_TextChanged);
			textBoxIndex.MouseDown += new MouseEventHandler(textBoxIndex_MouseDown);
			textBoxIndex.KeyPress += new KeyPressEventHandler(textBoxIndex_KeyPress);
			//
			// label1
			//
			...
			// treeSamples
			//
			treeSamples.BackColor = System.Drawing.SystemColors.Window;
			treeSamples.BorderStyle = System.Windows.Forms.BorderStyle.None;
			treeSamples.Font = new Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			treeSamples.AfterCollapse += new TreeViewEventHandler(treeSamples_AfterCollapse);
			treeSamples.AfterSelect += new TreeViewEventHandler(treeSamples_AfterSelect);
			treeSamples.AfterExpand += new TreeViewEventHandler(treeSamples_AfterExpand);
			//
			// imageListTree
			//
			imageListTree.ImageStream = ((ImageListStreamer)(resources.GetObject("imageListTree.ImageStream")));
			imageListTree.TransparentColor = System.Drawing.Color.Transparent;
			...
			panelHeader.Size = new Size(840, 157);
			panelHeader.TabIndex = 1;
			//
			// pictureBoxHeaderRight
			//
			pictureBoxHeaderRight.Dock = System.Windows.Forms.DockStyle.Right;
			pictureBoxHeaderRight.Image = ((Image)(resources.GetObject("pictureBoxHeaderRight.Image")));
			pictureBoxHeaderRight.Location = new Point(416, 0);
			...
			//
			pictureBoxHeaderLeft.Dock = System.Windows.Forms.DockStyle.Left;
			...
			pictureBoxHeaderLeft.Size = new Size(247, 157);
			pictureBoxHeaderLeft.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize;
			pictureBoxHeaderLeft.TabIndex = 1;
			pictureBoxHeaderLeft.TabStop = false;
			//
			// pictureBoxHeaderMidle
			//
			pictureBoxHeaderMidle.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			pictureBoxHeaderMidle.Size = new Size(840, 157);
			pictureBoxHeaderMidle.TabIndex = 2;
			pictureBoxHeaderMidle.TabStop = false;
			//
			// splitterVertical
			//
			splitterVertical.BackColor = System.Drawing.Color.White;
			splitterVertical.Location = new Point(256, 157);
			splitterVertical.MinSize = 100;
			splitterVertical.Name = "splitterVertical";
			splitterVertical.Size = new Size(3, 436);
			splitterVertical.TabIndex = 2;
			splitterVertical.TabStop = false;
			splitterVertical.SplitterMoving += new SplitterEventHandler(splitterVertical_SplitterMoving);
			splitterVertical.SplitterMoved += new SplitterEventHandler(splitterVertical_SplitterMoved);
			//
			// panelContent
			//
			...
			panelContent.Size = new Size(581, 436);
			panelContent.TabIndex = 3;
			panelContent.Resize += new EventHandler(panelContent_Resize);
			//
			// panelWebBrowser
			//
			panelWebBrowser.Anchor = ((AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			panelWebBrowser.Controls.Add(webBrowser1);
			panelWebBrowser.Location = new Point(32, 32);
			panelWebBrowser.Name = "panelWebBrowser";
			panelWebBrowser.Size = new Size(488, 80);
			panelWebBrowser.TabIndex = 4;
			panelWebBrowser.Visible = false;
			panelWebBrowser.Resize += new EventHandler(panelWebBrowser_Resize);
			//
			// webBrowser1
			//
			...
			// tabControlSample
			//
			tabControlSample.Anchor = ((AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			tabControlSample.Font = new Font("Microsoft Sans Serif", 8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			tabControlSample.Size = new Size(581, 300);
			tabControlSample.TabIndex = 2;
			tabControlSample.Vertical = true;
			//
			// buttonSamplePrevious
			//
			buttonSamplePrevious.Anchor = ((AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			buttonSamplePrevious.BackColor = System.Drawing.Color.White;
			buttonSamplePrevious.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			buttonSamplePrevious.Font = new Font("Verdana", 8F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			buttonSamplePrevious.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(59)))), ((int)(((byte)(105)))));
			buttonSamplePrevious.Location = new Point(648, 180);
			...
			buttonSamplePrevious.Click += new EventHandler(buttonSamplePrevious_Click);
			//
			// buttonSampleNext
			//
			buttonSampleNext.Anchor = ((AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			buttonSampleNext.BackColor = System.Drawing.Color.White;
			buttonSampleNext.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			buttonSampleNext.Font = new Font("Verdana", 8F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			buttonSampleNext.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(59)))), ((int)(((byte)(105)))));
			buttonSampleNext.Location = new Point(760, 180);
			...
			buttonSampleNext.Click += new EventHandler(buttonSampleNext_Click);
			//
			// labelSampleTitle
			//
			labelSampleTitle.Anchor = ((AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			labelSampleTitle.BackColor = System.Drawing.Color.White;
			labelSampleTitle.Font = new Font("Verdana", 16F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			labelSampleTitle.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(59)))), ((int)(((byte)(105)))));
			labelSampleTitle.ImageAlign = System.Drawing.ContentAlignment.MiddleRight;
			labelSampleTitle.Location = new Point(264, 144);
			labelSampleTitle.Name = "labelSampleTitle";
			labelSampleTitle.Size = new Size(580, 33);
		...
		private void LoadSettings()
		{
			...
			{
				Text = elemList[0].InnerText.Trim();
			}
			else
			{
			...
			if (elemList != null && elemList.Count == 1)
			{
				samplesNamespace = elemList[0].InnerText.Trim();
			}
			else
			{
				throw (new InvalidOperationException(errorMsg));
			...
			if (elemList != null && elemList.Count == 1)
			{
				Icon = new Icon(Application.StartupPath + "\\" + elemList[0].InnerText.Trim());
			}
			else
			{
				throw (new InvalidOperationException(errorMsg));
			...
			pictureBoxHeaderLeft.Image = LoadConfigImage(configXmlDocument, "HeaderImageLeft");
			pictureBoxHeaderMidle.Image = LoadConfigImage(configXmlDocument, "HeaderImageMiddle");
			pictureBoxHeaderRight.Image = LoadConfigImage(configXmlDocument, "HeaderImageRight");
		...
		{
			tabControlSample.SuspendLayout();
			panelContent.SuspendLayout();
			SuspendLayout();

			UserControl userControl = null;
			userControl = (UserControl)Assembly.GetEntryAssembly().CreateInstance(samplesNamespace + "." + sampleInfo.sampleControl);

			// Save current sample path
			CurrentSampleInfo = sampleInfo;
			CurrentSamplePath = applicationPath + "\\";
			CurrentSamplePath += sampleInfo.path;

			// Make sure sample tab is the first one
			if (tabControlSample.TabPages[0].Text != "Sample")
			{
				for (int index = 0; index < tabControlSample.TabPages.Count; index++)
				{
					if (tabControlSample.TabPages[index].Text == "Sample")
					{
						tabControlSample.TabPages.SetTabIndex(tabControlSample.TabPages[index], 0);
						break;
					}
				}
			}
			...
			if (userControl != null)
			{
				...
				if (scaleRatioX != 1f || scaleRatioY != 1f)
				{
					userControl.Scale(new SizeF(scaleRatioX, scaleRatioY));
				}
				...
				if (tabControlSample.TabPages[0].Controls.Count > 0)
				{
					int count = tabControlSample.TabPages[0].Controls[0].Controls.Count;
					for (int i = (count - 1); i >= 0; i--)
					{
						Control control = tabControlSample.TabPages[0].Controls[0].Controls[i];
						if (control != null)
						{
							control.Dispose();
						}
					}
					tabControlSample.TabPages[0].Controls[0].Dispose();
				}
				tabControlSample.TabPages[0].Controls.Add(userControl);
			}

			// Check if tabs can be resused.
			for (int index = 1; index < tabControlSample.TabPages.Count; index++)
			{
				bool reuse = false;
				...
				{
					if (infoPage.title == tabControlSample.TabPages[index].Text)
					{
						reuse = true;
						break;
					}
				...
				if (!reuse)
				{
					...
					if (tabControlSample.TabPages[index].Controls[0] == panelWebBrowser)
					{
						panelWebBrowser.Visible = false;
						Controls.Add(panelWebBrowser);
					}
					tabControlSample.TabPages.Remove(tabControlSample.TabPages[index]);
					--index;
				}
			}
			...
			foreach (object obj in sampleInfo.infoPages)
			{
				...
				for (int index = 0; index < tabControlSample.TabPages.Count; index++)
				{
					if (infoPage.title == tabControlSample.TabPages[index].Text)
					{
						tabPage = tabControlSample.TabPages[index];

						// Adjust tab control index
						if (tabIndex != index)
						{
							tabControlSample.TabPages.SetTabIndex(tabPage, tabIndex);
						}
					}
				}
				...
				string infoFileName = applicationPath + "\\" + sampleInfo.path + "\\" + infoPage.data;
				...
				if (infoPage.title.ToUpper().Contains("C#", StringComparison.CurrentCulture))
				{
					sourceConverter = new SourceCodeToRtf();
					sourceConverter.LoadLanguageDefinition(applicationPath + "\\cs_langDef.xml");
				}
				else if (infoPage.title.Contains("Visual Basic", StringComparison.CurrentCulture))
				{
					sourceConverter = new SourceCodeToRtf();
					sourceConverter.LoadLanguageDefinition(applicationPath + "\\vbnet_langDef.xml");
				}
				...
				if (infoFileName.EndsWith(".HTM") || infoFileName.EndsWith(".HTML"))
				{
					...
					{
						if (tabPage.Controls[0] == panelWebBrowser)
						{
							reusedControl = true;
						}
						else
					...
					if (!reusedControl)
					{
						...
						panelWebBrowser.Dock = DockStyle.Fill;
						tabPage.Controls.Add(panelWebBrowser);
					}
			...
			foreach (object obj in sampleInfo.infoPages)
			{
				...
				if (infoPage.title == "Sample")
				{
					...
					if (tabIndex > 0)
					{
						VerticalTabPage page = tabControlSample.TabPages[0];
						tabControlSample.TabPages.RemoveAt(0);
						tabControlSample.TabPages.Insert(tabIndex, page);
					}
					break;
				}
				++tabIndex;
			...
			tabControlSample.TabPages[0].Invalidate();

			// Set sample title
			labelSampleTitle.Text = sampleInfo.shortBlurb;

			// Resume layout
			tabControlSample.ResumeLayout(false);
			panelContent.ResumeLayout(false);
			ResumeLayout(false);
		...
		private void buttonSampleNext_Click(object sender, EventArgs e)
		{
			// Build nodes list
			...
			// Get current node
			TreeNode selectedNode = lastSelectedNode;
		...
		private void buttonSamplePrevious_Click(object sender, EventArgs e)
		{
			// Build nodes list
			if (contentNodes.Count == 0)
			{
		...
		private void panelWebBrowser_Resize(object sender, EventArgs e)
		{
			webBrowser1.Width = panelWebBrowser.Width + 4;
			webBrowser1.Height = panelWebBrowser.Height + 4;
		}
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
			...
			FillSamplesTree(treeSamples);

			// Load first sample
			if (treeSamples.Nodes.Count > 0)
			{
				foreach (TreeNode treeNode in treeSamples.Nodes[0].Nodes)
				{
		...
		/// Tree node selected.
		/// </summary>
		private void treeSamples_AfterSelect(object sender, TreeViewEventArgs e)
		{
		...
		{
			if (textBoxIndex.Text.Length > 0 && !ignoreTextChange)
			{
				int foundIndex = listBoxIndex.FindString(textBoxIndex.Text);
				if (foundIndex != ListBox.NoMatches)
				{
					indexEditorChanged = true;
					listBoxIndex.SelectedIndex = foundIndex;
					listBoxIndex.TopIndex = foundIndex;
				}
			}
		}
		...
		/// <param name="sender">Sender</param>
		/// <param name="e">Arguments</param>
		private void textBoxIndex_MouseDown(object sender, MouseEventArgs e)
		{
		...
		private void textBoxIndex_KeyPress(object sender, KeyPressEventArgs e)
		{
			...
			if (e.KeyChar == '\r')
			{
				...
				listBoxIndex_SelectedIndexChanged(this, new EventArgs());
		...
		/// </summary>
		private void splitterHorizontal_Move(object sender, EventArgs e)
		{
		...
		/// <param name="e"></param>
		private void tabControlSample_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (tabControlSample.SelectedIndex >= 0)
			{
				...
				{
					CurrentRichTextBox = (RichTextBox)tabControlSample.TabPages[tabControlSample.SelectedIndex].Controls[0];
				}
			}
		}
		...
		private void tabControlContent_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (tabControlContent.SelectedIndex == 0)
			{
				...
				if (CurrentSampleInfo != null &&
					...
					CurrentSampleInfo != treeSamples.SelectedNode.Tag)
				{
					findSample = true;
				}
				...
				if (findSample)
				{
					...
					{
						if (treeNode.Tag != null && treeNode.Tag == CurrentSampleInfo)
						{
							treeSamples.SelectedNode = treeNode;
							break;
						}
		...
		{
			if (indexEditorChanged)
			{
				indexEditorChanged = false;
				return;
			}
		...
		private void splitterVertical_SplitterMoving(object sender, SplitterEventArgs e)
		{
		...
		private void MainForm_Resize(object sender, EventArgs e)
		{
			if (WindowState != FormWindowState.Minimized)
			{
				...
				if (panelTree.Width > Width - pictureBoxHeaderRight.Image.Width - splitterVertical.Width)
				{
					panelTree.Width = Width - pictureBoxHeaderRight.Image.Width - splitterVertical.Width;
		...
		*/
		private void treeSamples_AfterCollapse(object sender, TreeViewEventArgs e)
		{
			e.Node.ImageIndex = 0;
			e.Node.SelectedImageIndex = 0;
		}

		private void treeSamples_AfterExpand(object sender, TreeViewEventArgs e)
		{
			e.Node.ImageIndex = 1;
			e.Node.SelectedImageIndex = 1;
		}

		private void contextMenuRTF_Popup(object sender, EventArgs e)
		{
			bool copyEnabled = true;
			if (CurrentRichTextBox != null &&
				CurrentRichTextBox.SelectedText.Length == 0)
			{
				copyEnabled = false;
			}
		}
		...
		private void menuItemCopy_Click(object sender, EventArgs e)
		{
			if (CurrentRichTextBox != null)
			{
				Clipboard.SetDataObject(CurrentRichTextBox.SelectedText.Replace("\n", "\r\n"));
			}
		}
		...
		private void menuItemCopyAll_Click(object sender, EventArgs e)
		{
			if (CurrentRichTextBox != null)
			{
				Clipboard.SetDataObject(CurrentRichTextBox.Text.Replace("\n", "\r\n"));
			}
		}
		...
		private void FillSamplesTree(TreeView tree)
		{
			...
			// Fill index list
			listBoxIndex.BeginUpdate();
			foreach (object obj in indexInfoList)
			{
				listBoxIndex.Items.Add(obj);
			}
			listBoxIndex.EndUpdate();
		}
		...
		{
			// Define item names
			for (int index = 0; index < indexInfoList.Count; index++)
			{
				IndexInfo indexInfo = (IndexInfo)indexInfoList[index];
				...
				if (indexInfo.SubKey.Length > 0)
				{
					...
					indexInfoList.Insert(index, mainKeyInfo);
					++index;
				}
			}

			// Remove duplicated items
			for (int index1 = 0; index1 < indexInfoList.Count; index1++)
			{
				IndexInfo indexInfo1 = (IndexInfo)indexInfoList[index1];
				for (int index2 = index1 + 1; index2 < indexInfoList.Count; index2++)
				{
					IndexInfo indexInfo2 = (IndexInfo)indexInfoList[index2];
						...
						indexInfo1.SubKey == indexInfo2.SubKey)
					{
						...
						{
							indexInfoList.RemoveAt(index2);
							--index2;
						}
						else if (indexInfo1.SampleInfo.sampleControl.Length == 0)
						{
							indexInfoList.RemoveAt(index1);
							--index1;
							--index2;
						}
				...
				try
				{
					...
					while (sampleNode != null)
					{
						if (sampleNode.Name == "SampleConfig")
						{
							...
							newAttr.Value = dirs[loop].Remove(0, applicationPath.Length + 1);
		...
		public class IndexInfo : IComparable
		{
			...
			public int CompareTo(object obj)
			{
				if (obj is IndexInfo)
				{
					...
					if (Key != info2.Key)
					{
						return Key.CompareTo(info2.Key);
					}
					return SubKey.CompareTo(info2.SubKey);
				}
				return 0;
			}
		}
